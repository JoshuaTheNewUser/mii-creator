...
export const settingsInfo: Record<string, any> = {
  ...
  shaderType: {
    ...
    choices: [
      ...
      { label: "Miitomo (Broken)", value: ShaderType.Miitomo, disabled: true },
    ],
  },
  ...
  bodyModel: {
    ...
    choices: [
      ...
      { label: "Face Raiders", value: BodyType.faceraiders },
      { label: "MAE", value: BodyType.MAE },
      { label: "Personal Trainer Walking", value: BodyType.ptw },
      { label: "StreetPass", value: BodyType.streetpass },
      { label: "Wii Party", value: BodyType.wiiparty },
      { label: "Wii Play", value: BodyType.wiiplay },
    ],
  },
  bodyModelHands: {
    type: "checkbox",
